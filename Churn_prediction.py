...
df = pd.read_csv(r"C:\Users\DELL PC\Documents\DATA SCIENCE BOOTCAMP\MACHINE LEARNING\Updated_churn_dataset.csv")
df2 = pd.read_csv(r"C:\Users\DELL PC\Documents\DATA SCIENCE BOOTCAMP\MACHINE LEARNING\Datasets\WA_Fn-UseC_-Telco-Customer-Churn.csv")
